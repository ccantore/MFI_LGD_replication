...
tauH=CH + taxH - HH*W - KS*RK*lambdash - (R*(lambdash*(B - PIN*ZN) + PIN*ZN*lambdanh))/PIH;
tauN=HN*W - ZN - taxN - CN + KS*RK*lambdasn + (R*(lambdasn*(B - PIN*ZN) + PIN*ZN*lambdann))/PIN;
...
Sconst=CS+IS+ZS/P-(W*HS+lambdass*RK*K/PIS+Rn*BS/(P*PIS)+profits/PIS -tauS-taxS/(P)); %%To double check steady state is correct

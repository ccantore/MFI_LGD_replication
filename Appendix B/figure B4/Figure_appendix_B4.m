...
RESULT_names={'KSHNK_AFAM_KK08_KH02_results.mat','KSHNK_AFAM_KK07_KH02_results.mat','KSHNK_AFAM_KK09_KH02_results.mat','KSHNK_AFAM_KK08_KH05_results.mat'}; %%EXACT NAMES OF THE RESULTS FILES TO LOAD
...
Model_names=char('\lambda_{KK}=0.8 \lambda_{K,H}=0.02','\lambda_{KK}=0.7 \lambda_{K,H}=0.02',['\lambda_{KK}=0.9 \lambda_' ...
    '{K,H}=0.02'],'\lambda_{KK}=0.8 \lambda_{K,H}=0.03'); %NAMES OF THE MODEL VARIANTS TO APPEAR IN THE LEGEND OF THE GRAPHS

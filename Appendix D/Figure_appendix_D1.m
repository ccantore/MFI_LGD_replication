...
RESULT_names={'KSHNK_PFPM_results.mat','KSHNK_AFPM_results.mat'};%%EXACT NAMES OF THE RESULTS FILES TO LOAD

lin_vs_nonlin=[0,0,0,0]; % = 0 if corresponding model non-linear, 1 otherwise
Model_names=char('\phi_{\pi}=0.8 \gamma^{\tau}=1','\phi_{\pi}=0.8 \gamma^{\tau}=0.5'); %NAMES OF THE MODEL VARIANTS TO APPEAR IN THE LEGEND OF THE GRAPHS

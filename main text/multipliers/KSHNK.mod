...
[name='Tax Rule']
log(tax/STEADY_STATE(tax))=rho_tauT*log(tax(-1)/STEADY_STATE(tax))+(1-rho_tauT)*(gamma_T*log(B(-1)/STEADY_STATE(B))+phi_tauT_G*log(G/STEADY_STATE(G)));
...
%%%%%%%%%%%%%%%%%%%%%%%%%
stoch_simul(order=1,irf=1000,nograph,noprint);

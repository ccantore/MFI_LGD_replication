...
residual = zeros(95, 1);
    ...
    residual(7) = (y(104)) - (y(19)+y(45)+y(63)/y(53)-(y(23)*y(30)+y(43)*y(3)/params(33)+y(1)*y(9)/(params(33)*y(53))+y(37)/params(33)-params(27)-y(56)/y(53)));
    ...
    residual(12) = (y(21)+y(64)/y(53)) - (y(30)*y(24)+y(1)*y(11)/(params(35)*y(53))-params(28)-y(58)/y(53));
...
residual(17) = y(62);
    ...
    residual(19) = (y(20)) - (y(30)*y(22)+y(1)*y(10)/(params(34)*y(53))-y(57)/y(53)+params(16));
    residual(20) = (y(32)) - (T(3)*T(4));
    residual(21) = (y(31)) - (y(32)-params(17));
    residual(22) = (y(33)) - (T(5)*T(6));
    residual(23) = (y(30)) - (y(33)*y(34));
    residual(24) = (y(31)) - (y(37)+y(43)*y(3)+y(30)*y(26));
...
residual(43) = 1-params(6)+y(34)*params(6)-y(29)*params(21)*(y(29)-1)+params(1)*params(21)*y(112)*y(109)/y(14)*(y(112)-1)*y(113)/y(31);
    ...
    residual(51) = (log(y(55)/(steady_state(42)))) - (params(12)*log(y(8)/(steady_state(42)))+(1-params(12))*(params(15)*log(y(12)/(steady_state(52)))+params(13)*log(y(54)/(steady_state(41)))));
